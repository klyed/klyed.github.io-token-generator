...
module.exports = {
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://klyed.github.io/token-generator' }],
    ['meta', { property: 'og:image', content: 'https://klyed.github.io/token-generator/assets/images/todo.jpg' }], // eslint-disable-line max-len
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:image', content: 'https://klyed.github.io/token-generator/assets/images/todo.jpg' }], // eslint-disable-line max-len
    ['script',
      {
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        text: 'Create Token',
        items: [
          { text: 'ERC20', link: 'https://klyed.github.io/erc20-generator/', target: '_self' },
          { text: 'BEP20', link: 'https://klyed.github.io/bep20-generator/', target: '_self' }
        ]
      }
    ]
  },
